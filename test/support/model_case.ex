defmodule GameScoring.ModelCase do
  @moduledoc """
  ...
  Given a Player schema that lists `:name` as a required field and validates
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&GameScoring.ErrorHelpers.translate_error/1)
